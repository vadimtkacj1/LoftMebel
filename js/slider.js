function start() {
    const images = document.querySelectorAll('.slider .slider-line div img');
    ...
    if (screenWidth > 500) {
        ...
        document.querySelector('.arrow-img_right').addEventListener('click', function () {
            count++;
        ...
        document.querySelector('.arrow-img_left').addEventListener('click', function () {
            count--;
            if (count < 0) {
